                        ...
                        <GridList cellHeight={350} cols={4} className={classes.gridListMain}>
                            {filterMovie.map((movie) => (
                                <GridListTile className="released-movie-grid-item" key={"grid" + movie.id}>
                                    <img src={movie.poster_url} className="movie-poster2" alt={movie.title} />
                                    <GridListTileBar
                                        title={movie.title}
                                        subtitle={
                                            <span>
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    <Select multiple input={<Input id="select-multiple-checkbox" />} renderValue={(selected) => selected.join(",")} value={this.state.artists} onChange={this.artistSelectHandler}>
                                        <MenuItem value="0">None</MenuItem>
                                        {artists.map((artist) => (
